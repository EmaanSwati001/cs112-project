        ...
        switch (choice) {
            ...
            case 2: { // Manage Environment
                ...
                if (envChoice >= 1 && envChoice <= 3) {
                    ...
                    eco+=2;
                    cout<<"encourage people to turn off the light when not in use\n";
...
bool handleUserSession() {
    ...
    while (!isLoggedIn) {
        ...
        cout << "-----------------------------------------\n";
        cout << (choice == 1 ? "\033[1;34m->\033[0;0m" : "  ") << " Login - Existing City\n";
        cout << (choice == 2 ? "\033[1;34m->\033[0;0m" : "  ") << " Register - New Mayor Account\n";
        cout << (choice == 3 ? "\033[1;34m->\033[0;0m" : "  ") << " Exit\n";
        cout << "-----------------------------------------\n";
